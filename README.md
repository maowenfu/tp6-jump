...
class Index 
{
    use \maowenfu\think\Jump; 
    public function index()
    {
        //return $this->error('error');
        //return $this->success('success','index/index');
        //return $this->redirect('/admin/index/index');
        return $this->result(['username' => 'maowenfu', 'sex' => '男']);  
    }
}
~~~
...
class Index extends \app\BaseController
{
    ...
    public function demo4()
    {
        ...
        return $this->result(['username' => 'maowenfu', 'sex' => '男']);
        //完整用法
        //return $this->result($data=['username' => 'maowenfu', 'sex' => '男'], $code = 0, $msg = '', $type = '',  $header = []); 
    }
}
~~~